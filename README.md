...
1. `diff_gauss_seidel_solver.py`: This file contains the implementation of the differentiable Gauss-Seidel solver, which is capable of handling various types of constraints such as distance-based, dihedral-based, and center of mass (COM) constraints.
